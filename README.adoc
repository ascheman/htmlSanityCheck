...
It can be used as Gradle plugin.
...
junitResultsDir:: (optional) directory where the results written to in JUnit XML format.
...
The existence of these files is checked by the plugin.
...
Having alt-attributes is good and defensive style.
